...
TAG_TO_MARKER = {
    ...
    # 新增维度 — 渠道/限额/安全/路由
    "channel-limit":        "negative",
    "daily-limit":          "negative",
    "biztype-limit":        "negative",
    "channel-biztype-combo":"negative",
    "single-limit":         "negative",
    "security-auth":        "negative",
    "security-face":        "negative",
    "security-sign":        "negative",
    "security-device":      "negative",
    "anti-replay":          "negative",
    "clearing-route":       "regression",
    "payee-validation":     "negative",
    "aml":                  "negative",
    "compliance":           "negative",
    "anti-fraud":           "negative",
}
